...
namespace SharedEnitityExample.Migrations
{
    ...
    [Migration("20230803112031_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseEntities.CommonPersonProfile", b =>
                {
                    ...
                    b.Property<string>("CommonUserAccountId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("CommonUserAccountId")
                        .IsUnique()
                        .HasFilter("[CommonUserAccountId] IS NOT NULL");
            ...
            modelBuilder.Entity("BaseEntities.CommonPersonProfile", b =>
                {
                    b.HasOne("BaseEntities.CommonUserAccount", "CommonUserAccount")
                        .WithOne("CommonPersonProfile")
                        .HasForeignKey("BaseEntities.CommonPersonProfile", "CommonUserAccountId");

                    b.Navigation("CommonUserAccount");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BaseEntities.CommonUserAccount", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BaseEntities.CommonUserAccount", b =>
                {
                    b.Navigation("CommonPersonProfile")
                        .IsRequired();
                });
